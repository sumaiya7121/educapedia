...
const Home = () => {
  ...
  <div className="hero-content text-center text-neutral-content">
    <div className="max-w-md">
      ...
      <button className="bg-amber-600 px-5 py-3 border rounded-lg shadow-2xl hover:bg-amber-700 transition duration-150 ease-in-out"><Link to='/courses'> Go to Courses</Link></button>
    </div>
  </div>
</div>
  );
